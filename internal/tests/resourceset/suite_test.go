...
func TestMain(m *testing.M) {
	...
	// Setup the ResourceSet controller with the manager.
	...
	}).SetupWithManager(testCtx, testEnv.Manager, controller.ResourceSetReconcilerOptions{
		WatchConfigsPredicate: predicate.Not(predicate.Funcs{}),
	}); err != nil {
		panic(fmt.Sprintf("failed to setup ResourceSetReconciler: %v", err))
	}

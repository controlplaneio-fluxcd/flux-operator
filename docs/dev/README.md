...
5. Run `make mcp-build-search-index` to download the docs index from fluxoperator.dev into `cmd/mcp/toolbox/library/index.json`; `prep-release` runs this target for every release.

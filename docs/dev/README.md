...
5. Run `make mcp-fetch-docs-index` to download the docs index from fluxoperator.dev into `cmd/mcp/toolbox/docindex/index.json`; `prep-release` runs this target for every release.

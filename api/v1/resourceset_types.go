...
type InputProviderReference struct {
	// Deprecated: The only accepted value is 'fluxcd.controlplane.io/v1'.
	// If the field is not set, it defaults to 'fluxcd.controlplane.io/v1'.
	// +kubebuilder:validation:Enum=fluxcd.controlplane.io/v1
	// +optional
	// +deprecated
	APIVersion string `json:"apiVersion,omitempty"`

	// Deprecated: The only accepted value is 'ResourceSetInputProvider'.
	// If the field is not set, it defaults to 'ResourceSetInputProvider'.

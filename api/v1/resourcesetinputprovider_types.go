...
// +kubebuilder:validation:XValidation:rule="self.type != 'ExternalArtifact' || has(self.selectors)", message="spec.selectors must be set when spec.type is 'ExternalArtifact'"

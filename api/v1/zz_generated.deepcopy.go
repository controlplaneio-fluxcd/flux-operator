...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InputsProvider) DeepCopyInto(out *InputsProvider) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InputsProvider.
func (in *InputsProvider) DeepCopy() *InputsProvider {
	if in == nil {
		return nil
	}
	out := new(InputsProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceSetSpec) DeepCopyInto(out *ResourceSetSpec) {
	*out = *in
	...
	if in.InputsFrom != nil {
		...
		*out = make([]InputsProvider, len(*in))
		copy(*out, *in)
	}
	if in.Resources != nil {

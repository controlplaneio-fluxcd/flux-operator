...
describe('InputsPanel component', () => {
  ...
  describe('Component rendering', () => {
    ...
    it('should be expanded by default', () => {
      ...
      expect(screen.getByRole('button', { name: /inputs/i })).toHaveAttribute('aria-expanded', 'true')
    })
  ...
  describe('Expand/collapse functionality', () => {
    it('should collapse when header is clicked', async () => {
      ...
      // Click to collapse
      const toggleButton = screen.getByRole('button', { name: /inputs/i })
  ...
  describe('Values tab', () => {
    ...
    it('should display inline inputs in YAML format', async () => {
      ...
      await waitFor(() => {
        const panel = screen.getByTestId('inputs-panel')
  ...
  describe('Edge cases', () => {
    it('should handle null resourceData gracefully', () => {
      render(<InputsPanel resourceData={null} namespace="default" />)
    ...
    it('should handle undefined resourceData gracefully', () => {
      render(<InputsPanel resourceData={undefined} namespace="default" />)

      ...
      <div class="flex items-center justify-center min-h-[60vh]">
        <div class="text-center">
          ...
          <button
            ...
            class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-flux-blue hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-flux-blue transition-colors"
          >
